    ...
    <a-row>
      <a-col :span="12" class="block-space-right">
        <a-card title="CPU信息" class="card-width">
          <a-table row-key="key" :columns="cpuColumns" :data-source="cpuData" :pagination="false"></a-table>
        </a-card>
      </a-col>
      <a-col :span="12" class="block-space-left">
        <a-card title="内存信息" class="card-width">
          <a-table row-key="key" :columns="memoryColumns" :data-source="memoryData" :pagination="false"></a-table>
        </a-card>
      </a-col>
    </a-row>
    <a-row>
    ...
    <a-row>
      <a-col :span="24" class="block-space-top">
        <a-card title="磁盘信息" class="card-width">
          <a-table row-key="dirName" :columns="diskColumns" :data-source="systemInfo.sysFiles" :pagination="false"></a-table>
        </a-card>
      </a-col>
    </a-row>
  </div>
